...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Technical Blog Post Writer - Write technical blog posts using AI"
    )
    parser.add_argument(
        "--use-langgraph",
        action="store_true",
        help="Use LangGraph-based implementation instead of original DecompositionAgent"
    )
    parser.add_argument(
        "--topic",
        type=str,
        help="Technical topic to write about (skips interactive prompt if provided)"
    )
    ...
    # Original DecompositionAgent implementation
    logger.info("="*60)
